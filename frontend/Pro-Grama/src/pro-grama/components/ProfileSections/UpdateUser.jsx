...
const passwordValidations = {
  newPassword: [
    ...
    "Password must at least have 8 characters and special character and uppercase",
  ],
  confirmPassword: [
    (value) => value.length >= 8,
    "Password must have more than 6 letters",
...
export const UpdateUser = ({ handleChange }) => {
  ...
  const {
    ...
    passwordValid,
    isFormValid,
  } = useForm(profile, formValidations);
  const {
    ...
    isFormValid: isPasswordsValid,
  } = useForm(initialForm, passwordValidations);
  // console.log(profile)
  ...
  return (
    <>
      <div className="mt-5 w-full flex justify-between items-center p-5 ">
        ...
        <div>
          <button
            ...
            class="focus:outline-none w-[15rem] text-Green bg-Blue hover:bg-Blue focus:ring-4 border-2 border-Green font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2   dark:focus:ring-green-800"
          >
      ...
      <div className="flex justify-center items-center">
        <form
          className="  p-6 h-fit mt-3 w-[40rem] mb-4 flex flex-col "
        ...
        >
          <div class="mb-6">
            ...
            <input
              ...
              id="email"
              class="bg-Blue border self-start border-white text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
          ...
          <div className="flex justify-between gap-4">
            <div class="mb-6 w-full">
              ...
              <input
                ...
                onChange={onInputChange}
                id="name"
                class="bg-Blue border border-white text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
          ...
          <div className="flex  items-center gap-3">
            ...
            <button
              type="button"
              onClick={handleOpen}
              class="text-Green mt-3 w-[200px] h-fit hover:text-white border border-Green hover:bg-Blue focus:ring-4 focus:outline-none focus:ring-Green font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2   dark:hover:text-white  dark:focus:ring-blue-800"
            >
              Cambiar contraseña
            </button>
          </div>
          <div className={open ? "flex justify-between gap-4" : "hidden"}>
            ...
            <div class="mb-6 w-full ">
              ...
              <input
                ...
                onChange={onPasswordChange}
                id="password"
                class="bg-Blue border border-white text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-white dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
              />
            </div>
          </div>
          <div className="flex justify-end mt-6">
            <button
              type="submit"
              class="text-white  bg-Green hover:bg-Blue focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  focus:outline-none dark:focus:ring-blue-800"
            >

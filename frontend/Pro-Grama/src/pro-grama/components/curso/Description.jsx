...
import { AiFillHeart,  AiOutlineHeart, AiOutlinePlus , AiOutlineClockCircle , AiOutlineUnorderedList } from "react-icons/ai";
      ...
      <div className="flex items-center px-32 my-4">
        <div className="flex justify-between w-3/5 items-center">
          ...
          <Button color="white" onClick={handleHearth} >
            {hearthPress ?  <AiOutlineHeart className="w-8 h-8" /> : <AiFillHeart className="w-8 h-8" /> }
          </Button>
        </div>
      ...
      <div className="flex px-32">
        <div className="flex-col w-3/5">
          ...
          <div className="flex justify-between p-4">
            <p className="py-4 flex items-center gap-2"> <AiOutlineUnorderedList/> {`${courseJsData.lessons} lecciones`}</p>
            <p className="py-4 flex items-center gap-2"> <AiOutlineClockCircle/> {`${courseJsData.hours} horas`}</p>
